"""Tests for common Messenger with A2A SDK integration.

RED phase: These tests should FAIL initially since common.messenger doesn't exist yet.
"""
...
class TestMessengerCleanup:
    ...
    async def test_messenger_close_closes_all_cached_clients(
        self, mock_client_factory, mock_client
    ):
