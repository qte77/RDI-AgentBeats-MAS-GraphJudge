...
- A2A Traceability Extension: InteractionStep, CallType (re-exported from common)
- JSON-RPC 2.0 Protocol: JSONRPCRequest, JSONRPCResponse (re-exported from common)
...
# Re-export shared models from common module for backward compatibility
